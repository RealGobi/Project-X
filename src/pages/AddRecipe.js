...
const AddRecipe = () => {
  ...
  return (
    <div className="addRecipe">
      <div className="header"><h1>Lägg till Recept</h1></div>
      <div className="addRecipe-addrecept">
        <h2>Nytt Recept</h2>
        ...
        <form>
          ...
          <label htmlFor="Beskrivning">Kort beskrivning: <input type="text" value={description} name="description" onChange={(e) => { setDesc(e.target.value); }} /></label>
...
export default connect(mapStateToProps, { addRecipe, deleteRecipe })(AddRecipe);
